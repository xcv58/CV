...
\tldatecventry{2011}{Research Proposal}{}{}{}
{\textbf{Studying the Topic of Extracting Attributes and Their Values of Domain Objects}
\begin{tightitemize}
  ...
  \item Train classifier by the sentences whichcontains the expression of attribute or attribute value
...
\tldatecventry{2010}{Theory and Method to Ontology Learning Field about Chinese Text}{}{}{}
{\textbf{Funded by National Natural Science Foundation of China}
  \begin{tightitemize}
  \item Took over projects - Tag the time expressions; Standardize the time expressions.
  \item Obtained and marked data, responsible for the Maintenance and optimization work.
  \item Engaged in designing and programming platform of ontology learning field-- Chinese free text.
  \item Achieved software copyright (owned by group member), which showed lab projects to the ordinary by performing in web-page.
  \end{tightitemize}
}

\tlcventry{2009}{2011}{Lab Work}{}{}{}
{\begin{tightitemize}
  \item Held discussion meeting about technical details in Lab
  \item Gave advice to students involved in thesis proposals
  \item Organized students to have thesis defense
  \end{tightitemize}
}
...
\cvcomputer
{C}{Implement all \href{http://www.eecs.harvard.edu/~syrah/os161/}{Havard OS/161} assignments}
...
{Emacs Lisp}{Very familiar with \href{http://osrc.dfm.io/xcv58}{Emacs Lisp}}

\cvcomputer
{JavaScript}{Familiar with javascript, wrote more than 5 bookmarklets}
{Other Languages}{
  {\LaTeX} in daily usage, I hate Office;\\
  Lua, wrote plugins for Goolge Pinyin;\\
  PHP, building websites;\\
